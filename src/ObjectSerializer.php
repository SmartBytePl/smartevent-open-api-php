...
use SmartEventSDK\Models\ModelInterface;
...
class ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ($class === '\SplFileObject') {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\SmartEventSDK\Model\\' . $data->{$discriminator};
     ...
     * @return array
     */
    public static function responseBuilder(ResponseInterface $response, ?string $returnType): array
    {
        if ($returnType === null) {
            $content = null;
        } elseif ($returnType === '\SplFileObject') {
