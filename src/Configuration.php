...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://test-se2.smartevent.pl/open-api';
    ...
    {
        $report  = 'PHP SDK (SmartEventSDK) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://test-se2.smartevent.pl/open-api",
                "description" => "No description provided",
            ],
            [
                "url" => "http://smartevent.test/open-api",
                "description" => "No description provided",
            ]
        ];
    }
