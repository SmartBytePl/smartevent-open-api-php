...
class OrdersApi
{
     ...
     * @param  string[] $participant_attributes Number of participant should be equal number of tickets (sum of values in qty field). (optional)
     ...
     * @param  string $additional_info customer comments for order (optional)
     * @param  string $_channel_code Code of the channel which should be used. If not passed it is resolved on domain base. (optional)
     ...
     * @return string
     */
    public function orderCreate($customer_name, $customer_surname, $customer_phone, $customer_email, $delivery_name, $delivery_surname, $delivery_phone, $id, $qty, $participant_name = null, $participant_surname = null, $participant_email = null, $participant_phone = null, $participant_comment = null, $participant_attributes = null, $customer_company = null, $customer_street = null, $customer_city = null, $customer_postcode = null, $customer_country_code = null, $customer_vatid = null, $customer_newsletter = null, $customer_facebook = null, $customer_linkedin = null, $customer_twitter = null, $customer_instagram = null, $customer_googleplus = null, $delivery_company = null, $delivery_street = null, $delivery_city = null, $delivery_postcode = null, $delivery_country_code = null, $delivery_vatid = null, $additional_info = null, $_channel_code = null, $currency_code = null, $locale_code = null, $coupon = null, $ref = null)
    {
    ...
    protected function orderCreateRequest($customer_name, $customer_surname, $customer_phone, $customer_email, $delivery_name, $delivery_surname, $delivery_phone, $id, $qty, $participant_name = null, $participant_surname = null, $participant_email = null, $participant_phone = null, $participant_comment = null, $participant_attributes = null, $customer_company = null, $customer_street = null, $customer_city = null, $customer_postcode = null, $customer_country_code = null, $customer_vatid = null, $customer_newsletter = null, $customer_facebook = null, $customer_linkedin = null, $customer_twitter = null, $customer_instagram = null, $customer_googleplus = null, $delivery_company = null, $delivery_street = null, $delivery_city = null, $delivery_postcode = null, $delivery_country_code = null, $delivery_vatid = null, $additional_info = null, $_channel_code = null, $currency_code = null, $locale_code = null, $coupon = null, $ref = null)
    {
        ...
        // query params
        if (is_array($participant_attributes)) {
            $participant_attributes = ObjectSerializer::serializeCollection($participant_attributes, 'multi', true);
        }
        if ($participant_attributes !== null) {
            $queryParams['participant_attributes[]'] = ObjectSerializer::toQueryValue($participant_attributes);
        }
        // query params
        ...
        if ($additional_info !== null) {
            $queryParams['additional_info'] = ObjectSerializer::toQueryValue($additional_info);
        }
        // query params
